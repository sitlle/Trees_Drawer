...
Info_Extra_Window::Info_Extra_Window(VERTEX<vertex_type> *Input_Vertex) :
    ...
    Info_[2] = "posX: " + std::to_string(Input_Vertex->real_vertex->param.posX);
    Info_[3] = "shift: " + std::to_string(Input_Vertex->real_vertex->param.sdv);
    Info_[4] = "left posX: " + std::to_string(Input_Vertex->real_vertex->param.LR.first);
    Info_[5] = "right posX: " + std::to_string(Input_Vertex->real_vertex->param.LR.second);
